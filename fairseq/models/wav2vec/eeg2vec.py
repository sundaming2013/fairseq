...
@register_model("eeg2vec", dataclass=Wav2Vec2Config)
class EEG2Vec2Model(BaseFairseqModel):
    def __init__(self, cfg: Wav2Vec2Config):
        ...
        self.feature_extractor = EEGConvFeatureExtractionModel(
...
class EEGConvFeatureExtractionModel(nn.Module):
    def __init__(
        self,
